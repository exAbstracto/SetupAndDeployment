...
# This script will orchestrate the medichain end-to-end execution of the Hyperledger
# Fabric network.
#
# The end-to-end verification provisions a medichain Fabric network consisting of
...
function printHelp () {
  echo "Usage: "
  echo "  medichain.sh -m up|down|restart|generate [-c <channel name>] [-t <timeout>] [-d <delay>] [-f <docker-compose-file>] [-s <dbtype>]"
  echo "  medichain.sh -h|--help (print this message)"
  ...
  echo
  echo "	medichain.sh -m generate -c mychannel"
  echo "	medichain.sh -m up -c mychannel -s couchdb"
  echo "	medichain.sh -m up -l node"
  echo "	medichain.sh -m down -c mychannel"
  echo "	medichain.sh -m up -a"
  echo
  echo "Taking all defaults:"
  echo "	medichain.sh -m generate"
  echo "	medichain.sh -m up"
  echo "	medichain.sh -m down"
}
